            ...
            <div class="col-lg-4">
                <div class="glass-card p-4 h-100">
                    ...
                    <ul class="text-muted small ps-3 mb-0">
                        ...
                        <li>Keep labels short for better badge rendering.</li>
                        <li>Deletion stays available but separate to avoid mistakes.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-0">
            <div class="p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <p class="mb-0 text-muted">Organize your ranges by specific worlds and edit them without leaving the table.</p>
                </div>
                <div class="admin-toolbar">
                    <div class="placeholder-banner mb-0" role="img" aria-label="Material palette - Metz, Pau, Ajaccio">
                        Ready-to-use modals
                    </div>
                    <span class="badge-subcategory">Safe editing</span>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content glass-card">
                    <div class="modal-header border-0">
                        <h5 class="modal-title" id="editSubCategoryLabel<%= sc.getId() %>">Edit sub-category</h5>

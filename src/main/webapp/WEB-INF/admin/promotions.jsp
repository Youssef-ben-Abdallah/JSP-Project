                ...
                <div class="glass-card p-4 h-100">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2">
                        <div>
                            ...
                            <p class="text-muted mb-0">Launch a limited-time offer. Every later change happens inside a dedicated modal.</p>
                        </div>
                        <span class="badge-subcategory">Guided planning</span>
                    </div>
                ...
                <div class="glass-card p-4 h-100">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Edit in modals: keep the context while adjusting the timing.</p>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle text-white promo-table">
                            ...
                            <%
                                ...
                                if (promos != null && !promos.isEmpty()) {
                                    ...
                                    for (Promotion promo : promos) {
                                        ...
                                        String endDisplay = endTime != null ? endTime.format(formatter) : "Not set";
                            %>
                            <tr>
                                <td>
                            ...
                            %>
                            <tr>
                                <td colspan="4" class="text-center text-muted py-4">No promotions yet.</td>
                            </tr>
                            <%
                                }
                            %>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content glass-card">
            <div class="modal-header border-0">
                <h5 class="modal-title" id="editPromotionLabel<%= promo.getId() %>">Edit promotion</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Discount type</label>
                            <select class="form-select" name="discountType">
                                        <option value="PERCENTAGE" <%= promo.isPercentage() ? "selected" : "" %>>Percentage</option>
                                        <option value="FIXED_AMOUNT" <%= promo.isPercentage() ? "" : "selected" %>>Fixed amount</option>
                            </select>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Description</label>

        ...
        <div class="card detail-card p-4">
            <div class="row g-4 align-items-center">
                <div class="col-md-5">
                    ...
                    %>
                    <div class="image-placeholder" role="img" aria-label="Immersive ambience in <%= location %>">
                ...
                <div class="col-md-7">
                    ...
                    <p class="mt-4 text-secondary">Decor inspired by <%= location %>: warm textures, soft light, and staging designed for your pop-up corners.</p>
                </div>
            </div>
        </div>
        <%

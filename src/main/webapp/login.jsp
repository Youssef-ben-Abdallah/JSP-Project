...
<div class="container" style="max-width: 520px;">
    <div class="card shadow-sm p-4">
        <div class="text-center mb-3">
            <span class="badge bg-primary-subtle text-primary fw-semibold">Secure area</span>
            <h3 class="mt-3">MyShop Administration</h3>
            <p class="text-muted mb-0">Sign in to manage categories, promotions, and collections.</p>
        </div>
